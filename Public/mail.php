<?php
define('admin_email','management@platinumairconditioning.com'); // Change admin email here for example admin@yoursite.com
define('website_name','PlatinumAirConditioning.com'); // Change website name here for example yoursite.com
